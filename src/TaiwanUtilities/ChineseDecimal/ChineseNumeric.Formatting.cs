...
partial struct ChineseNumeric : IFormattable
{
    ...
    /// 
    /// </summary>
    /// <param name="format"> 字串格式，參見 <see cref="ChineseNumericFormats"/>。
    /// </param>
    /// <returns></returns>
    ...
    private class Formatter : ICustomFormatter
    {
        ...
        public string Format(string format, object arg, IFormatProvider formatProvider)
        {
            if (arg is ChineseNumeric cn)
            {
                ...
                {
                    ChineseNumericFormats.TraditionalUppercase or "zh-TW" => Format(cn, FormatterProfile.TraditionalUppercase),
                    ChineseNumericFormats.TraditionalLowercase or "zh-tw" => Format(cn, FormatterProfile.TraditionalLowercase),
                    ChineseNumericFormats.SimplifiedUppercase or "zh-CN" => Format(cn, FormatterProfile.SimplifiedUppercase),
                    ChineseNumericFormats.SimplifiedLowercase or "zh-cn" => Format(cn, FormatterProfile.SimplifiedLowercase),
                    ChineseNumericFormats.FullWidth or "fw" => Format(cn, FormatterProfile.FullwidthWestern),
                    ChineseNumericFormats.HalfWidth or "hw" => Format(cn, FormatterProfile.HalfwidthWestern),
    ...
    internal class FormatterProfile
    {
