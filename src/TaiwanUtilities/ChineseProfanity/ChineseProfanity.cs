...
public static class ChineseProfanity
{
    ...
    {
        var aux = "((恁|琳|您|林|你|妳|祢|汝|他|她|它|牠|祂){1,2}(爹|娘|爸|(?<!媽)媽|馬|妹|姊|姐|老母|老師|娘親|親娘|奶奶|(阿|啊)(公|嬤)|全家|祖宗|姑媽|姑奶奶|太祖|開基祖)的?)?";
        ...
        var patterns = $$"""
                ...
                - (死|臭)?白{{aux}}(痴|癡|目|爛)
                - (死|臭)?(啟|乞){{aux}}智
                - (死|臭)?賤{{aux}}(屄|逼|B|鮑魚|畜|狗|女?人|貨|種|民?)
                - (死|臭)?(乞丐|要飯)
                - (死|臭)?混{{aux}}(帳|蛋)
                - (死|臭)?俗{{aux}}辣
                - (死|臭)?(狗{{aux}})?畜{{aux}}(生|牲)
                - (死|臭)?狗{{aux}}((娘|東西)(養的)?|(種|魚|碎))
                - (死|臭)?窩囊廢?
                - (死|臭)?雜{{aux}}(種|魚|碎)
                - (死)?弱{{aux}}(雞|智)
                - (死)?智{{aux}}(障|缺)
    ...
    private static readonly Lazy<Regex> s_pattern2 = new(static () => new(
        pattern: @"(?<PRE>(?#PRE1)真(他|她|它|牠|祂)(爹|娘|爸|(?<!媽)媽|馬)的?|(?#PRE2)(淦|贛|幹|姦|去|肏|操|襙|鄵|草|糙|耖|駛|賽)(死|破)?(恁|琳|您|林|你|妳|祢|汝|他|她|它|牠|祂){1,2}(爹|娘|爸|媽{1,2}|馬|妹|姊|姐|老母|老師|娘親|親娘|奶奶|全家|祖宗|姑媽|(阿|啊)(公|嬤)|姑奶奶|太祖|開基祖)(的|勒)?|(?#PRE3)(你|妳|祢)(他|她|它|牠|祂)?(娘|(?<!媽)媽|馬|老母|老師|奶奶|姑奶奶)的|(?#PRE4)((?<!媽)媽|馬)的)?",
        options: RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.RightToLeft | RegexOptions.Compiled | RegexOptions.Multiline,
        matchTimeout: TimeSpan.FromMilliseconds(250)));

    private static readonly Lazy<Regex> s_pattern3 = new(static () => new(
        pattern: @"[\u3000-\u303F\uFF00-\uFF60!""#$%&'()*+,\-./:;<=>?@\[\\\]^_`{|}~\s]*?(?<WORD>滾|靠|淦|贛|幹|姦|操|襙|鄵|糙|耖|肏)[\u3000-\u303F\uFF00-\uFF60!""#$%&'()*+,\-./:;<=>?@\[\\\]^_`{|}~\s]*?",
        options: RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.RightToLeft | RegexOptions.Compiled | RegexOptions.Multiline,
        matchTimeout: TimeSpan.FromMilliseconds(250)));
